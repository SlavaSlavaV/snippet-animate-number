...
/**
 * Анимация числовых счётчиков для Elementor Free
 * Применяется к любому элементу с классом .animate-num
 * Поддерживает data-duration и data-start атрибуты
 */
    ...
    <script>
        (function() {
            ...
            function findTextTarget(el) {
                ...
                if (el.firstChild?.nodeType === Node.TEXT_NODE && /\d+/.test(el.firstChild.nodeValue)) {
                    return el;
                }
